...
<html>
  <head>
    ...
    <link href="plugins/dist/css/skins/skin-purple.min.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="plugins/jsqrcode/webqr.js"></script>
  ...
  <body class="<?php if(isset($_SESSION["user_id"])):?>  skin-purple sidebar-mini <?php else:?>login-page<?php endif; ?>" >
    <div class="wrapper">
      <!-- Main Header -->
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg">Hospital</span>
        </a>
        ...
        <form action="./?action=processlogin" method="post">
          ...
          <div class="row">
            ...
            <div class="col-xs-12">
              ...
              <button onclick=" location.href='registrar.php' " type="button" class="btn btn-warning btn-block btn-flat">Registrate</button>
            </div><!-- /.col -->
          </div>
        </form>
      </div><!-- /.login-box-body -->
